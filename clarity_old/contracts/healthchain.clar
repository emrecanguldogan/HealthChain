;; HealthChain - Real NFT-based Access Control System
...
;; Error codes
;; u1: User already has NFT token
;; u2: User does not have NFT token
;; u3: Token not found
;; u4: Authorization not found
;; u5: Token ownership not found
